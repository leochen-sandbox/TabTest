...
public class JsonDeleteTask extends AsyncTask<Void, Void, ArrayList<HashMap<String, Object>>> {

    protected String URLPath;

    public JsonDeleteTask(String URLPath) {
    ...
    private String readBugzilla() {
        ...
        HttpDelete httpDelete = new HttpDelete(URLPath);
        try {
